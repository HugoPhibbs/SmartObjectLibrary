...
class LibraryObject:
    ...
    def __init__(self, object_id: str, identity_data: IdentityData, supporting_documents: dict[str, str],
                 property_sets: dict, units: dict[str, Unit], material: Material, profile: Profile | None = None):
